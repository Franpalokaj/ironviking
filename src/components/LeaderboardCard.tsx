  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full py-5 px-5">
        ...
        <div className="flex items-center w-full px-3 realm-title-row" style={{ marginTop: "10px" }}>
          <div className="flex-1 flex items-center justify-end gap-1.5 min-w-0">
            <Image unoptimized src={realmSrc} alt={realm.name} width={22} height={22} className="shrink-0" />
            <span className={`font-[family-name:var(--font-cinzel)] text-sm font-semibold ${realm.cssClass} truncate`}>
              {realm.name}
            </span>
          </div>
          <div className="mx-3 shrink-0" style={{ width: "1px" }} />
          <div className="flex-1 flex items-center justify-start gap-1.5 min-w-0">
            <Image unoptimized src={titleSrc} alt={title} width={22} height={22} className="shrink-0" />
            <span className={`${titleStyle.color} font-[family-name:var(--font-cinzel)] text-sm font-semibold ${titleStyle.glowClass || ""} truncate`}>
              {title}
            </span>
          </div>
        </div>
        ...
        {/* XP Bar */}
        <div className="w-[95%] mx-auto xp-bar-row" style={{ marginTop: "20px" }}>
